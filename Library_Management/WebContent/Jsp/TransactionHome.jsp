...
<title><s:text name="TransactionHome.title"></s:text></title>
...
<s:text name="project.welcome"></s:text> <s:property value="#session.username"/><hr/> <br/><br/>
<p align="center" style="font-size: x-large">
	<a href="<s:url action='issue'/>"><s:text name="TransactionHome.link.issuebook"></s:text></a>  <br/><br/>
	<a href="<s:url action='return'/>"><s:text name="TransactionHome.link.returnbook"></s:text></a>  <br/><br/>
</p>
<hr/>
</body>
</html>