...
<h3 align="center">Return Book</h3><hr/>
<s:form action="returnAction">
<table align="center">
<tr><td><s:textfield key="books_return.bookid" name="book_id"></s:textfield><br/></td></tr>
<tr><td><s:submit key="books_return.returnbook"></s:submit></td></tr>
</table>
</s:form>
</body>
</html>