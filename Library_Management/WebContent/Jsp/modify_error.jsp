...
<title><s:text name="modify_error.title"></s:text></title>
...
<table width="100%">
<tr><td align="left"><a href='<s:url action='librarianHome' />' ><s:text name="project.home"></s:text></a></td>
...
<hr/>
<h3 align="center"><s:text name="modify_error.msg"></s:text></h3>
</body>
</html>