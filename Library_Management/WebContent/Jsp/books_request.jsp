...
<title><s:text name="books_request.title"></s:text></title>
...
<table align="center">
<tr><td><s:textfield name="user_id" key="books_request.userid"></s:textfield></td></tr>
<tr><td align="center"><s:submit name="button" value="Check Request"></s:submit></td></tr>
</table>
</s:form>
</body>
</html>